...
public:
	...
	// virtual void typeAnalysis(TypeAnalysis *);
	virtual void typeAnalysis(TypeAnalysis *, const DataType * dt = nullptr); // Overloaded method
};
...
public:
	...
	virtual void typeAnalysis(TypeAnalysis *, const DataType * dt = nullptr) override;
...
public:
	...
	bool nameAnalysis(SymbolTable * symTab) override;
	void typeAnalysis(TypeAnalysis * typing, const DataType * dt = nullptr) override;
private:
	IDNode * myID;
	TypeNode * myType;
	ExpNode * myInit;
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable * symTab) override;
	virtual void typeAnalysis(TypeAnalysis *, const DataType *) override;
private:
	LocNode * myDst;
	ExpNode * mySrc;
};
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	void unparseNested(std::ostream& out) override;
	LocNode * getCallee() const { return myCallee; }
	bool nameAnalysis(SymbolTable * symTab) override;
	virtual void typeAnalysis(TypeAnalysis *) override;
private:
	LocNode * myCallee;
