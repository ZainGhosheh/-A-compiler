  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_maybeformals = 58,                     // maybeformals
        S_formalsList = 59,                      // formalsList
        S_formalDecl = 60,                       // formalDecl
        S_stmtList = 61,                         // stmtList
        S_blockStmt = 62,                        // blockStmt
        S_stmt = 63,                             // stmt
        S_exp = 64,                              // exp
        S_callExp = 65,                          // callExp
        S_actualsList = 66,                      // actualsList
        S_term = 67,                             // term
        S_loc = 68,                              // loc
        S_id = 69                                // id
      };
