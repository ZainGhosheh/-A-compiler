...
public:
	...
	inline void attachSymbol(SemSymbol * symbolIn)
	{
		mySymbol = symbolIn;
	}
...
public:
	...
	std::list<DeclNode *> * getMembers() const{ return myMembers; }
private:
	IDNode * myID;
...
public:
	...
	std::list<ExpNode *> * getArgs() const { return myArgs; }
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	virtual std::string getName() override { return myField->getName(); }
	virtual bool nameAnalysis(SymbolTable *) override;
private:
	LocNode * myBase;
	IDNode * myField;
...
public:
	...
	void unparse(std::ostream& out, int indent) override;
	bool nameAnalysis(SymbolTable *) override;
	TypeNode * getSub() const { return mySub; }
private:
	TypeNode * mySub;
};
